      ...
      <main>
        <section className="bg-secondary-500 poster pt-4 relative text-opacity-60 text-white sm:px-4">
          <div className="container mx-auto relative">
            <nav className="flex flex-wrap items-center px-4 py-2"> <a href="#" className="font-bold gap-2 hover:text-gray-300 inline-flex items-center leading-none mr-4 text-3xl text-white"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34.142 40" width="1.5em" height="1.5em" fill="currentColor">
            ...
            </svg><span className="uppercase">NFT Marketplace</span></a>
              ...
              <div className="flex-1 hidden space-y-2 w-full lg:flex lg:items-center lg:space-x-4 lg:space-y-0 lg:w-auto" data-name="nav-menu">
                <div className="flex flex-col ml-auto lg:flex-row"> <a href="/" className="font-medium hover:text-gray-300 py-2 text-opacity-60 text-white lg:p-4 xl:px-6">Home</a>
                  <a href="/create" className="font-medium hover:text-gray-300 py-2 text-opacity-60 text-white lg:p-4 xl:px-6">Create</a>
                </div><a href="#" className="bg-gradient-to-t bg-primary-500 font-bold from-primary-500 hover:bg-primary-600 hover:from-primary-600 hover:to-primary-500 inline-block px-6 py-2 rounded text-white to-primary-400">My NFTs</a>
              </div>
            </nav>
          </div>
          ...
          <div className="py-4">
            ...
            <div className="flex flex-wrap -mx-4  items-center">
              ...
              <div className="px-4 py-2 w-full sm:w-auto"> 
                <a href="#" className="hover:text-primary-600 text-primary-500">Privacy Policy</a> | <a href="#" className="hover:text-primary-600 text-primary-500">Terms of Use</a>
              </div>
            </div>
          </div>
        </div>
