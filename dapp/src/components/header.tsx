    ...
    return (
        <div className="container mx-auto relative">
            <nav className="flex flex-wrap items-center px-4 py-2">
                <Link href="/" className="font-bold gap-2 hover:text-gray-300 inline-flex items-center leading-none mr-4 text-3xl text-white">
                    ...
                    </svg><span className="uppercase">NFT Marketplace</span>
                </Link>
